...
PAIRS = [
    ...
    ("quarantined", "work", "drive-goal: the watchdog parked a spin",
     "triage_signatures: repeated-ending"),
    ("quarantined", "harness", "drive-goal", "triage_signatures: campaign-futility"),
    ("quarantined", "environment", "drive-goal",
