...
was not there. `DRIVE_HELPER` names it now, and a machine that names none
...
class HelperTest(unittest.TestCase):
    def test_a_named_helper_is_what_the_commands_are_built_from(self):
        with mock.patch.dict(os.environ, {"DRIVE_HELPER": "/srv/tools/sc"}):
    ...
    def test_no_helper_named_means_no_helper_command(self):
        with mock.patch.dict(os.environ, {"DRIVE_HELPER": ""}):
    ...
    def test_the_live_guard_hook_is_the_loops_own_file_not_the_repositorys(self):
        ...
        with mock.patch.dict(os.environ, {"DRIVE_REPO": "/srv/some/other/repo"}):
