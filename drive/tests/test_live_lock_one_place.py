...
then from `DRIVE_LIVE_LOCK`, so two drivers with different environments made
...
# name is the test's own throwaway, so this never reaches `drive-live`.
DRIVER = f"""
import sys
