...
hold is a person's decision, and the loop does not schedule around it. Where a wave is
wider than the cap, the same line says how wide, what the cap is and how many turns it
will take.
