...
class SignatureTest(unittest.TestCase):
    ...
    def test_a_file_outside_the_card_is_the_rig(self):
        output = "File /tmp/graph-x/task-T1/simulation/tests/other.py, line 4"
        said = classify(ending({"kind": "failed", "step": "gate"}, output=output))
    ...
    def test_a_speaking_gate_repeating_is_work(self):
        first = "AssertionError at /tmp/graph-a/task-T1/simulation/app.py:44"
        again = "AssertionError at /tmp/graph-b/task-T1/simulation/app.py:44"
        said = classify(ending({"kind": "failed", "step": "gate"},
    ...
    def test_two_lines_of_one_file_are_two_failures(self):
        ...
        first = "AssertionError at /tmp/graph-a/task-T1/simulation/app.py:44 in test_one"
        again = "AssertionError at /tmp/graph-b/task-T1/simulation/app.py:55 in test_one"
        said = classify(ending({"kind": "failed", "step": "gate"},
                               output=again, history=(first, again)))
