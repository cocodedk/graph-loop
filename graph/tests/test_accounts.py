...
class TheAccountTable(unittest.TestCase):
    ...
    def test_an_account_with_its_own_configuration_sets_it(self):
        with unittest.mock.patch.dict(os.environ, {"GRAPH_ACCOUNTS": "work,second=~/second"}):
    ...
    def test_a_third_account_needs_no_code(self):
        with unittest.mock.patch.dict(os.environ, {"GRAPH_ACCOUNTS": "work,second=/cfg/second,spare=/cfg/spare"}):
    ...
    def test_an_empty_setting_falls_back_to_the_one_account_we_ship(self):
        with unittest.mock.patch.dict(os.environ, {"GRAPH_ACCOUNTS": "  "}):
