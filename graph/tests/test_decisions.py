...
class AskTest(unittest.TestCase):
    def test_a_well_formed_reply_answers_every_question(self):
        ...
        self.assertEqual(sorted(asked["questions"]), sorted(out.answers))
    ...
    def test_the_request_carries_the_state_and_each_questions_own_criteria(self):
        ...
        self.assertEqual({"left", "right"}, set(asked["questions"]["one"]["criteria"]))
        self.assertEqual("choice", asked["questions"]["two"]["type"])
        self.assertEqual("Which size?", asked["questions"]["two"]["instructions"])
