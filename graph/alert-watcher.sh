...
BODY="The graph campaign's board went red — detected $(date -Is) by the supervisor's deterministic tick.
...
send_target() {  # $1 = role (decides the account), $2 = exact relay name
  ...
  # GRAPH_MESSENGER=1 marks this as the throwaway messenger call, not a real
